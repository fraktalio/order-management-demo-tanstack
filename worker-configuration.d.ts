/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fee022e8004581bb63257896b723a6dc)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		DATABASE_URL: string;
		MY_WORKFLOW: Workflow<Parameters<import("./src/server").MyWorkflow['run']>[0]['payload']>;
	}
}
